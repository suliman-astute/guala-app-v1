        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e($page); ?></h5>
                </div>
...
<style>.choices__list--dropdown{ z-index:2055 }</style> 
<?php $__env->stopSection(); ?>
...
<script>
    ...
    function loadGridData() {
        fetch("<?php echo e(route('gestione_turni_presse.json')); ?>") // <-- GET
            .then(r => {
    ...
    function createItem() {
        ...
        $('#ModalManage .modal-body').load("<?php echo e(route('gestione_turni_presse.create')); ?>/", function(){
    ...
    function updateItem(id) {
        $('#ModalManage .modal-body').html("");
        $('#ModalManage .modal-body').load("<?php echo e(route('gestione_turni_presse.create')); ?>/" + id, function(){
            afterFormLoaded();                  // <--- e qui!
        });
        $('#ModalManage').modal('show');
    }
    ...
    function deleteItem(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.post("<?php echo e(route('gestione_turni_presse.destroy')); ?>", {
                    id_to_del: id,
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\guala\guala-app\resources\views/gestione_turni_presse/table.blade.php ENDPATH**/ ?>