<form id="async" method="POST" action="<?php echo e(route('gestione_turni_presse.store')); ?>">
    <?php echo csrf_field(); ?>
...
<script>
    ...
    $(function () {
        $('#async').on('submit', function (e) {
            ...
            $.ajax({
                url: "<?php echo e(route('gestione_turni_presse.store')); ?>",
                method: "POST",
                data: $(this).serialize(),
...
<?php /**PATH C:\xampp\htdocs\guala\guala-app\resources\views/gestione_turni_presse/form.blade.php ENDPATH**/ ?>