<?php $__env->startSection('title', "Dizionario"); ?>
...
<script>
    ...
    function loadGridData(api) {
        fetch("<?php echo e(route('traduzioni.json')); ?>", {
                method: "GET",
                headers: {
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\guala\guala-app\resources\views/traduzioni/table.blade.php ENDPATH**/ ?>