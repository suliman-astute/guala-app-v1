...
<script>
    ...
    const columnDefs = [
        { headerName: "Dominio", field: "dominio", flex: 1 },
        { headerName: "Host", field: "host", flex: 1 },
        { headerName: "Base DN", field: "base_dn", flex: 1 },
        { headerName: "Porta", field: "porta", flex: 1 },
        {
            headerName: 'Azioni',
    ...
    function loadGridData() {
        fetch("<?php echo e(route('ad.json')); ?>", {
            method: 'POST',
            headers: {
    ...
    function createItem() {
        ...
        $('#ModalManage .modal-body').load("<?php echo e(route('ad.create')); ?>");
        $('#ModalManage').modal('show');
    }

    function updateItem(id) {
        $('#ModalManage .modal-body').html("");
        $('#ModalManage .modal-body').load("<?php echo e(route('ad.create')); ?>/" + id);
        $('#ModalManage').modal('show');
    }
    ...
    function deleteItem(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.post("<?php echo e(route('ad.destroy')); ?>", {
                    id_to_del: id,
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\guala\guala-app\resources\views/ad/table.blade.php ENDPATH**/ ?>