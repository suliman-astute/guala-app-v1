<?php $__env->startSection('title', "Monitor GUALA FP"); ?>
...
<script>
  ...
  function aggiornaTimer() {
    ...
    function openPage(schedule){
      ...
      const url = new URL("<?php echo e(route('monitor_fp.pdf_stampaggio_fp.stampa')); ?>", window.location.origin);
...
function saveComment(machineSatmp, prodNo, commento) {
  $.ajax({
    url: '<?php echo e(route("monitor_fp.save_comment")); ?>', // crea la route sotto
    method: 'POST',
    data: { machineSatmp, prodNo, commento, _token: '<?php echo e(csrf_token()); ?>' },
...
function loadGridData(filters = lastFilters) {
  const base = new URL("<?php echo e(route('monitor_fp.data')); ?>", window.location.origin);
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\guala\guala-app\resources\views/app/monitor_fp/index.blade.php ENDPATH**/ ?>