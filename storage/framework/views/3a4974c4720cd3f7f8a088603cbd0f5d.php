...
<script>
    ...
    function loadGridData() {
        fetch("<?php echo e(route('sites.json')); ?>", {
            method: 'POST',
            headers: {
    ...
    function createItem() {
        ...
        $('#ModalManage .modal-body').load("<?php echo e(route('sites.create')); ?>");
        $('#ModalManage').modal('show');
    }

    function updateItem(id) {
        $('#ModalManage .modal-body').html("");
        $('#ModalManage .modal-body').load("<?php echo e(route('sites.create')); ?>/" + id);
        $('#ModalManage').modal('show');
    }
    ...
    function deleteItem(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.post("<?php echo e(route('sites.destroy')); ?>", {
                    id_to_del: id,
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\guala\guala-app\resources\views/sites/table.blade.php ENDPATH**/ ?>