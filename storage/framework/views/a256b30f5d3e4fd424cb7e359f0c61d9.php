...
<script>
    ...
    const columnDefs = [
        ...
        { headerName: "Inizio", field: "inizio", flex: 1 },
        { headerName: "Fine", field: "fine", flex: 1 },
    ...
    function loadGridData() {
        fetch("<?php echo e(route('turni.json')); ?>", {
            method: 'POST',
            headers: {
    ...
    function createItem() {
        ...
        $('#ModalManage .modal-body').load("<?php echo e(route('turni.create')); ?>");
        $('#ModalManage').modal('show');
    }

    function updateItem(id) {
        $('#ModalManage .modal-body').html("");
        $('#ModalManage .modal-body').load("<?php echo e(route('turni.create')); ?>/" + id);
        $('#ModalManage').modal('show');
    }
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\guala\guala-app\resources\views/turni/table.blade.php ENDPATH**/ ?>