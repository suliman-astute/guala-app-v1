<form id="async" method="POST">
    ...
    <div class="row">
        <div class="col-6 mb-2">
            ...
            <input class="form-control form-control-sm" type="text" name="name" value="<?php echo e($site->name); ?>">
...
<script>
    ...
    $(function() {
        ...
        $('#async').submit(function(e) {
            ...
            $.ajax({
                url: '<?php echo e(route('sites.store')); ?>',
                type: 'POST',
                data: formData,
                contentType: false,
                cache: false,
...
<?php /**PATH C:\xampp\htdocs\guala\guala-app\resources\views/sites/form.blade.php ENDPATH**/ ?>