        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Manage <?php echo e($page); ?></h5>
                </div>
...
<?php $__env->startSection('js'); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            var apiUrl = "<?php echo e(route('active_apps.json')); ?>";
        ...
        function loadGridData(api) {
            fetch("<?php echo e(route('active_apps.json')); ?>", {
                    method: "POST",
                    headers: {
    ...
    <script>
        function createItem() {
            ...
            $('#ModalManage .modal-body').load("<?php echo e(route('active_apps.create')); ?>");
            $('#ModalManage').modal('show');
        }

        function updateItem(id) {
            $('#ModalManage .modal-body').html("");
            $('#ModalManage .modal-body').load("<?php echo e(route('active_apps.create')); ?>/" + id);
            $('#ModalManage').modal('show');
        }
        ...
        function deleteItem(id) {
            Swal.fire({
                ...
                if (result.value === true) {
                    ...
                    $.post("<?php echo e(route('active_apps.destroy')); ?>", {
                            id_to_del: id,
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\guala\guala-app\resources\views/active_apps/table.blade.php ENDPATH**/ ?>