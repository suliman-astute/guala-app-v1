        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Gestione <?php echo e($page); ?></h5>
                </div>
...
<script>
    ...
    const columnDefs = [
        ...
        { headerName: "Posizione", field: "GUAPosition", flex: 1 },
        { headerName: "ID Mes", field: "id_mes", flex: 1 },
        { headerName: "Ingressi Usati", field: "ingressi_usati", flex: 1 },
        { headerName: "Id Piovan", field: "id_piovan", flex: 1 },
        { headerName: "Azienda", field: "azienda", flex: 1 },
        { headerName: "GUA Schedule", field: "GUA_schedule", flex: 1 },
        {
            headerName: 'Azioni',
    ...
    function loadGridData() {
        fetch("<?php echo e(route('presse.json')); ?>", {
            method: 'POST',
            headers: {
    ...
    function createItem() {
        ...
        $('#ModalManage .modal-body').load("<?php echo e(route('presse.create')); ?>");
        $('#ModalManage').modal('show');
    }

    function updateItem(id) {
        $('#ModalManage .modal-body').html("");
        $('#ModalManage .modal-body').load("<?php echo e(route('presse.create')); ?>/" + id);
        $('#ModalManage').modal('show');
    }
    ...
    function deleteItem(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.post("<?php echo e(route('presse.destroy')); ?>", {
                    id_to_del: id,
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\guala\guala-app\resources\views/presse/table.blade.php ENDPATH**/ ?>