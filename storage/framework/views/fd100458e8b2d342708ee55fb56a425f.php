<form id="async" method="POST" action="<?php echo e(route('macchine.store')); ?>">
    <?php echo csrf_field(); ?>
    ...
    <div class="form-group mb-3">
        ...
        <input type="text" class="form-control" name="GUAPosition"
...
<script>
    $(function () {
        $('#async').on('submit', function (e) {
            ...
            $.ajax({
                url: "<?php echo e(route('macchine.store')); ?>",
                method: "POST",
                data: $(this).serialize(),
...
<?php /**PATH C:\xampp\htdocs\guala\guala-app\resources\views/macchine/form.blade.php ENDPATH**/ ?>