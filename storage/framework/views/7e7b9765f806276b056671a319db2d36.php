<?php $__env->startSection('title', "Monitor Gauala DIS"); ?>
...
<script>
    window.LABELS_STAMPAGGIO = <?php echo json_encode($trad_stampaggio, 15, 512) ?>;
    window.LABELS_ASSEMBLAGGIO = <?php echo json_encode($trad_assemblaggio, 15, 512) ?>;
</script>
...
<script>
    ...
    function openPage(tipoPagina){
        ...
        if(tipoPagina==1){
         // alert(tipoPagina);
          url = new URL("<?php echo e(route('app1.pdf.stampa')); ?>", window.location.origin);   
        } 
        else {  url = new URL("<?php echo e(route('app1.pdf_stampaggio.stampa')); ?>", window.location.origin);}
    ...
    window.openPopup = function(orderNo, parentitemNo) {
        ...
        const urlPattern = `<?php echo e(route('ordine.info.dettagli', ['id' => ':id', 'parentitemNo' => ':parentitemNo'])); ?>`;
    ...
    $(document).on('change', '.comment-input', function () {
        ...
        $.ajax({
            ...
            method: 'POST',
            data: { id: id, commento: comment, _token: '<?php echo e(csrf_token()); ?>' },
                ...
                },
                {
                    ...
                    onCellValueChanged: function(params) {
                        ...
                        $.ajax({
                            url: '<?php echo e(url("/save-comment")); ?>',
                            method: 'POST',
                            data: { id: id, commento: newComment, _token: '<?php echo e(csrf_token()); ?>' },
                            success: function (response) { toastr.success('Commento salvato!'); },
                            error: function () { toastr.error('Errore nel salvataggio del commento!'); }
                        });
                    }
    ...
    function loadGridDataAssemblaggio(api) {
        fetch("<?php echo e(url('/tableviewAssemblaggio')); ?>", {
            method: "GET",
    ...
    function loadGridData(api) {
        fetch("<?php echo e(url('/tableview')); ?>", {
            method: "GET",
            headers: { "Content-Type": "application/json", "X-CSRF-TOKEN": document.querySelector('meta[name="csrf-token"]').content }
        })
        .then(res => res.json())
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\guala\guala-app\resources\views/app/APP1/index.blade.php ENDPATH**/ ?>