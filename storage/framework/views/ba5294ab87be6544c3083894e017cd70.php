...
function loadGridData(api) {
    fetch("<?php echo e(route('users.json')); ?>", {
                            method: "POST",
                            headers: {
    ...
    <script>
        function createItem() {
            ...
            $('#ModalManage .modal-body').load("<?php echo e(route('users.create')); ?>");
            $('#ModalManage').modal('show');
        }

        function updateItem(id) {
            $('#ModalManage .modal-body').html("");
            $('#ModalManage .modal-body').load("<?php echo e(route('users.create')); ?>/" + id);
            $('#ModalManage').modal('show');
        }

        function updateActiveApp(id) {
            $('#ModalManage .modal-body').html("");
            $('#ModalManage .modal-body').load("<?php echo e(route('users.form_active_apps')); ?>/" + id);
            $('#ModalManage').modal('show');
        }
        ...
        function deleteItem(id) {
            Swal.fire({
                ...
                if (result.value === true) {
                    ...
                    $.post("<?php echo e(route('users.destroy')); ?>", {
                            id_to_del: id,
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\guala\guala-app\resources\views/users/table.blade.php ENDPATH**/ ?>